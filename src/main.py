...
class DuckHuntGame:
    ...
    def load_images(self):
        ...
        # Set transparent color for each image
        transparent_color = (0, 0, 0)  # Assuming magenta is not present in your images
        for image in self.bird_images:
            image.set_colorkey(transparent_color)
        # Scale images to 40x40
        self.bird_images = [pygame.transform.scale(image, (50, 50)) for image in self.bird_images]
